...
//Constructor
   public PersonThakkar (String firstname , String lastname , String phone , String email)
   {
...
//Equals Method   
   ...
   {
      if (o instanceof PersonThakkar)
      {
         PersonThakkar p = (PersonThakkar)o  ;//Type casting the object
...
class Passenger extends PersonThakkar  
{
//Instance Variable 
